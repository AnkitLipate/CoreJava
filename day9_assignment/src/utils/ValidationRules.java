...
public class ValidationRules {
	...
	public static String validateDept(String dept) throws EmployeeHandlingException {
		switch (dept) {
		case "rnd":
		case "HR ":
		case "Finance":
		...
		default:// => invalid dept
			throw new EmployeeHandlingException("Invalid Dept....!!!!");
	...
	// caller
	public static int validateEmpId(int empId, Employee[] empData) throws EmployeeHandlingException
	// empId=sc.nextInt(), empData = emp
	{
		Employee newEmp = new Employee(empId);
		// how are you going to chk for dups? Employee's equals
