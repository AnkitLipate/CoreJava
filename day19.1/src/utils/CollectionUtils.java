...
public class CollectionUtils {
	public static List<Product> populateData(){
		...
		products.add(new Product(55, "orange", FRUITS, parse("2019-01-01"), 350));
		products.add(new Product(35, "wheat", GRAINS, parse("2018-07-11"), 700));
		return products;
	}
	//add static method : which will copy ref's from the List--->Map
	public static Map<Integer, Product> populateMapFromList(List<Product> list)
	{
